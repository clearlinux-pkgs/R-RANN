...
Version  : 2.6
Release  : 11
URL      : https://cran.r-project.org/src/contrib/RANN_2.6.tar.gz
Source0  : https://cran.r-project.org/src/contrib/RANN_2.6.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1531797255
